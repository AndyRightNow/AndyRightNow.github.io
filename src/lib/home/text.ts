...
export function loadNameText() {
  ...
  window.requestAnimationFrame(() => {
    ...
    debugLog('[text]', glyphMeshes.length, 'glyph meshes created, total physicsMeshes:', $.physicsMeshes.length)
    ...
    if ($.physics) {
      ...
      debugLog('[text] physics NOT ready yet, bodies will be added by setupPhysics')
    }
