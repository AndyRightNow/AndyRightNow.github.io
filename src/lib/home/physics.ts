...
import { $ } from './state'
import { loadingManager } from './scene'
...
export function addCustomPhysicsBody(
  ...
  debugLog('[physics] addCustomPhysicsBody', { mesh: (mesh as any).name || 'glyph', mass, restitution, sx, sy, sz })
